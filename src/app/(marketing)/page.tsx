...
import { FileText, Users, Calendar, FolderOpen, Receipt, BarChart3, Shield, Clock, Globe, Check, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      icon: FileText,
      title: "Dava Takibi",
      description: "Tüm davalarınızı tek merkezden yönetin. Duruşma tarihleri ve otomatik hatırlatmalar.",
    },
    {
      icon: Users,
      title: "Müvekkil Yönetimi",
      description: "Müvekkil bilgilerini güvenle saklayın. İletişim geçmişi ve dosya ilişkilendirme.",
    },
    {
      icon: Calendar,
      title: "Akıllı Takvim",
          ...
          <Container>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Dava takibi, müvekkil yönetimi ve ajanda özellikleriyle büronuzun verimliliğini artırın.
